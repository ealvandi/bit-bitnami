    ...
    ListProperties.prototype.addItem = function (propertiesGot, property, properties) {
        ...
        switch (propertiesGot[property].type) {
            ...
            case "text":
               ...
               // input = $("<input type='text' style='" + width + "' id1='" + id + "'    class='anNewClass' >").val(propertiesGot[property].value);
                // #ehsan
                // $("text").getControl().css("class", "anNewClass");
                // $("text").css("class", "anNewClass");
